                ...
                <CardContent className="p-0">
                  ...
                  <div className="relative aspect-[16/10] overflow-hidden bg-gradient-to-br from-brand-orange/10 to-brand-blue/10">
                    ...
                    <div className="absolute top-4 left-4">
                      <Badge className="bg-brand-orange/10 text-brand-orangeText border-0">
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="font-bold text-xl text-gray-900 dark:text-gray-100 mb-3 line-clamp-2 group-hover:text-brand-orangeText transition-colors">
                      {blog.title}
                    </h3>
