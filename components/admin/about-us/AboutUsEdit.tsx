  ...
  <Edit>
    <TabbedForm>
      ...
      <FormTab label="Hero Section">
        ...
        <TextInput source="hero_cta_primary_text" label="Primary CTA Text" />
        <TextInput source="hero_cta_primary_url" label="Primary CTA URL" />
        <TextInput source="hero_cta_secondary_text" label="Secondary CTA Text" />
        <TextInput source="hero_cta_secondary_url" label="Secondary CTA URL" />
      </FormTab>
      ...
      <FormTab label="Call to Action">
        <TextInput source="cta_title" label="CTA Title" fullWidth />
        <CKEditorInput source="cta_description" label="CTA Description" />
        <TextInput source="cta_primary_text" label="Primary Button Text" />
        <TextInput source="cta_primary_url" label="Primary Button URL" />
        <TextInput source="cta_secondary_text" label="Secondary Button Text" />
        <TextInput source="cta_secondary_url" label="Secondary Button URL" />
        <SimpleImageUpload 
