  ...
  async fetchPageData(): Promise<ContactPageData> {
    try {
      ...
      const contactData = {
        ...
        address: baseData.siteSettings?.company_address || 'Dar Al Wuheida Building - Office No. 319 - Abu Hail - Dubai - United Arab Emirates',
        city: baseData.siteSettings?.company_city || 'Dubai',
        country: baseData.siteSettings?.company_country || 'United Arab Emirates',
        map_url: baseData.siteSettings?.map_url || 'https://maps.app.goo.gl/kcy1snMZ59b8qwHdA',
